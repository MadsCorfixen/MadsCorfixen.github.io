...
You can use the [editor on GitHub](https://github.com/Divixity/Divixity.github.io/edit/main/index.md) to maintain and
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in
 your [repository settings](https://github.com/Divixity/Divixity.github.io/settings). The name of this theme is
